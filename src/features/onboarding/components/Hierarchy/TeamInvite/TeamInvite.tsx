...
export const TeamInvite = ({ onClose }: TeamInviteProps) => {
  ...
  const [addedMembers] = useState<AddedMember[]>([
    { id: 1, name: 'John Doe', avatar: '/users/user-1.jpg' },
    { id: 2, name: 'Jane Smith', avatar: '/users/user-5.jpg' },
    { id: 3, name: 'Mike Johnson', avatar: '/users/user-6.jpg' },
    { id: 4, name: 'Sarah Williams', avatar: '/users/user-7.jpg' },
    { id: 5, name: 'Tom Brown', avatar: '/users/user-8.jpg' },
    ...
    <div className={styles.invite}>
      ...
      <div className={styles.invite__modal}>
        ...
        <div className={styles.invite__tabs}>
          <button
            className={`${styles.invite__tabs__item} ${activeTab === 'email' ? styles.invite__tabs__item__active : ''
              }`}
          ...
          <button
            className={`${styles.invite__tabs__item} ${activeTab === 'user' ? styles.invite__tabs__item__active : ''
              }`}
        ...
        <form className={styles.invite__form} onSubmit={handleSubmit}>
          {activeTab === 'email' ? (
            ...
            <>
              <div className={styles.invite__row}>
                <div className={styles.invite__field}>
                  <label className={styles.invite__label}>Name</label>
                  <input
                    type="text"
                    className={styles.invite__input}
                    placeholder="Name"
                ...
                <div className={styles.invite__field}>
                  <label className={styles.invite__label}>Surname</label>
                  <input
                    type="text"
                    className={styles.invite__input}
                    placeholder="Surname"
              ...
              <div className={styles.invite__field}>
                <label className={styles.invite__label}>Position</label>
                <div className={styles.invite__select}>
                  <select
                    className={styles.invite__select__input}
              ...
              <div className={styles.invite__field}>
                <label className={styles.invite__label}>Department</label>
                <div className={styles.invite__select}>
                  <select
                    className={styles.invite__select__input}
          ...
          <button type="submit" className={styles.invite__submit}>
            {activeTab === 'email' ? 'Send Invitation' : 'Add User'}
          </button>
        </form>
